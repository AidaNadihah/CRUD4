<%-- 
    Document   : loginadmin
    Created on : Jul 9, 2021, 9:44:15 PM
    Author     : USER
--%>
...
out.print(login_msg);  
 ...
 %>  
  <div class="main" >
    ...
    <form class="form1" method="post" action="Adminprofile.jsp">
      <input class="un " type="text" align="center" placeholder="Admin ID" name="empId">
