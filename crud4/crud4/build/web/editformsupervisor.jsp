<%-- 
    Document   : editformsupervisor
    Created on : Jul 9, 2021, 10:28:17 AM
    Author     : USER
--%>
...
<html>
    <head>
        <title>Edit Form Supervisor</title>
        <meta charset="UTF-8">
...
<ul>
    <div class="sidenav"> 
            <li><a href="supervisorview.jsp">History Leave</a></li>
            <li><a href="supervisorprofile.jsp">Profile</a></li>
            <li><a href="loginsupervisor.jsp">Logout</a></li>
      </div>
  </ul>
          
        <div class="box">
<h1>Leave Form</h1>  
<form action="editempsuper.jsp" method="post">  
...
<tr><td>Status:</td><td> 
<select name="status" style="width:155px" value="<%=u.getStatus() %>">
