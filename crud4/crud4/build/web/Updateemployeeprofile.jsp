<%-- 
    ...
    Created on : Jul 8, 2021, 4:31:08 PM
    Author     : azri
--%>
...
<ul>
    <div class="sidenav">  
        ...
        <%@page import="com.las.formdao,com.las.Employeeprofile"%>  
  
<%  
String id=request.getParameter("id");  
Employeeprofile u=formdao.getProfileById(Integer.parseInt(id));  
%>  
     ...
     <form action="Updateprocess.jsp" method="post">
        ...
        <table>
            <tr><td>Employee Id</td><td>
                    <input type="text" name="empId" value="<%=u.getEmpId() %>" /></td></tr>
		<tr><td>Name</td><td>
		...
		<input type="text" name="empId" value="<%=u.getDepartment() %>" /></td></tr>
